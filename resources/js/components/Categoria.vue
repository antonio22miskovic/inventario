        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
         ...
         <div class="container">
            <div class="row justify-content-center">
            	<p>desea anadir una nueva categoria: <a class="btn btn-outline-success rounded-pill " data-toggle="modal" data-target="#modalregistrarcategoria"> <font-awesome-icon icon="plus" />  </a> </p>
					<table class="table ">
                         ...
                         <button class="btn btn-outline-warning text-center" data-toggle="modal" data-target="#editar"  @click.prevent="editar(categoria, paginate.current_page)">
                             <font-awesome-icon icon="marker" />
                          </button>
                        </td>
              					<td class="text-center">
                          <button class="btn btn-outline-danger text-center"  @click.prevent="eliminar(categoria, paginate.current_page)">
                            <font-awesome-icon icon="trash" />
                        </button>
                      </td>
              					<td class="text-center">
                          <button class="btn btn-outline-primary text-center" data-toggle="modal" data-target="#detallesmodalcenter" @click.prevent="detalles(categoria)">
